...
fn square(point: Point, width: f32) -> Rectangle {
    Rectangle {
        top_left: Point { x: point.x, y: point.y + width },
        bottom_right: Point { x: point.x + width, y: point.y },
    }
}
...
fn main() {
    ...
    println!("Area of rectangle: {:?}", _rectangle);
    ...
    println!("Square: {:?}", square(point, 2.5));
}
